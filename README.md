# Salt Swap V1.10.47 — Crypto News Feed
...
- Preserves V1.10.47 Social profile layout and functionality.

# Salt Swap V1.10.47 — Social Reconnect Profile Fix

Fixes existing-profile wallet reconnect so Social always restores the full Profile layout instead of falling back to the legacy token-review screen. Also fixes the Social tab renderer scope bug and defaults reconnects to Profile. Preserves V1.10.47 banner persistence and all prior features.
...
## V1.10.47 — Salt Social account-first onboarding
...
V1.10.47 fixes: real full-width white Social canvas; hides floating background art on Social; removes global main width cap while Social is active; adds missing Vercel routes for social NFTs, holdings, and profile feed.
...
- Existing V1.10.47 layout and profile behavior are preserved.
...
- Preserves the V1.10.47 profile reconnect behavior and all prior Social profile features.

## V1.10.47 — Auto-Scrolling Checker Ticker
...
- Preserves V1.10.47 feed routing, CA-only custom tickers, auto-scroll, and all prior Social/profile behavior.


## V1.10.47 — Parachute meme coin background
...
## V1.10.47 — Social sheep branding
...
## V1.10.47 — exact uploaded sheep icon
...
## V1.10.47 — Off-white Social bar + feed box
...
## V1.10.47 — Trench paper + military frames
...
## V1.10.47 — Accurate parchment + wooden NFT frames
...
## V1.10.47 — NFT wooden frame correction
