# Salt Swap V1.10.48 — Crypto News Feed
...
- Preserves V1.10.48 Social profile layout and functionality.

# Salt Swap V1.10.48 — Social Reconnect Profile Fix

Fixes existing-profile wallet reconnect so Social always restores the full Profile layout instead of falling back to the legacy token-review screen. Also fixes the Social tab renderer scope bug and defaults reconnects to Profile. Preserves V1.10.48 banner persistence and all prior features.
...
## V1.10.48 — Salt Social account-first onboarding
...
V1.10.48 fixes: real full-width white Social canvas; hides floating background art on Social; removes global main width cap while Social is active; adds missing Vercel routes for social NFTs, holdings, and profile feed.
...
- Existing V1.10.48 layout and profile behavior are preserved.
...
- Preserves the V1.10.48 profile reconnect behavior and all prior Social profile features.

## V1.10.48 — Auto-Scrolling Checker Ticker
...
- Preserves V1.10.48 feed routing, CA-only custom tickers, auto-scroll, and all prior Social/profile behavior.


## V1.10.48 — Parachute meme coin background
...
## V1.10.48 — Social sheep branding
...
## V1.10.48 — exact uploaded sheep icon
...
## V1.10.48 — Off-white Social bar + feed box
...
## V1.10.48 — Trench paper + military frames
- Adds aged-paper texture throughout Social/Profile.
- Restyles Profile/Feed/Following and main navigation with paper-like controls.
- Gives Featured NFT slots rugged olive military frames.
- Converts Wallet Holdings into a SUPPLY CRATE panel.
- Converts Top Calls and Profile Stats into FIELD REPORT-style panels.
- Keeps existing functionality and content intact.


## V1.10.48 — Accurate parchment + wooden NFT frames
- Reworked Social background to a warmer aged parchment texture closer to the approved mockup.
- Rebuilt Featured NFT slots as hanging wooden picture frames with nail, rope, bevels and parchment Choose NFT plaques.
- Refined Supply Crate and Field Report panels to feel less like colored SaaS cards and more like trench props.
- Converted central profile/thesis surfaces to worn parchment styling.


## V1.10.48 — NFT wooden frame correction
- Removes the incorrect diagonal striped/crate treatment from Featured NFT slots.
- Rebuilds NFT slots as hanging wooden picture frames with nail, cord, beveled wood rails and inset portrait area.
- Keeps Choose NFT on a parchment plaque below the portrait.
- Softens the page texture to look more like aged parchment and less like a dotted UI pattern.


## V1.10.48 — clean off-white rollback for Social cards/nav
- Removes the extra Featured NFT topper/nail/cord treatment above NFT frames.
- Keeps the wooden NFT frame itself.
- Reverts Profile/Feed/Following and the top Social nav to the cleaner off-white style.
- Reverts Wallet Holdings, Top Calls, and Profile Stats from crate/field-report props back to clean off-white cards.
- Keeps the off-white/paper palette across Social.
